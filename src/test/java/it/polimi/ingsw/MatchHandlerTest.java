...
//
//    @Test
//    public void aThirdPlayerConnectBeforeTimeoutButLogEndsAfter() throws IOException, InterruptedException {
//        //Given
//        new MatchHandlerTest();
//        matchHandler.start();
//        socketHandler.start();
...
//        inputStream2.readUTF();
//        //Third Client
//        Socket socket3= new Socket(InetAddress.getLocalHost(), 11000);
//        DataInputStream inputStream3= new DataInputStream(socket3.getInputStream());
//        DataOutputStream outputStream3= new DataOutputStream(socket3.getOutputStream());
//        String username3 = new String("PlayerName3"); //When server is full isn't important if the username is already in use.
//        inputStream3.readUTF();
//
//        //When (after timeout)
//        Thread.sleep(17000); //FIXME when timer is changed.
//        outputStream3.writeUTF(username3);
//        String result=inputStream3.readUTF();
//
//        assertEquals(2, matchHandler.connectedPlayers());
//        assertEquals("Server is full, can't connect!", result);
//    }

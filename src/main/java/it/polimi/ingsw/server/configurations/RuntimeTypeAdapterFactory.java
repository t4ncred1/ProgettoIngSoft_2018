 ...
 *  - https://stackoverflow.com/questions/19588020/gson-serialize-a-list-of-polymorphic-objects?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
 *
 * gitHub link: https://github.com/google/gson/blob/master/extras/src/main/java/com/google/gson/typeadapters/RuntimeTypeAdapterFactory.java
 *
...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
   ...
   *
   * @author Andrea Costanzo (Relative issue on git: https://github.com/google/gson/issues/712)
   */
  @Override
  public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type) {
    if (null == type || !baseType.isAssignableFrom(type.getRawType())) { //Here was the bug (andre)
      return null;
    }
